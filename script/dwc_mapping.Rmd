...
```{r}
occurrence %<>% mutate(dwc_samplingSizeValue = no_fuiken) 
```
### sampleSizeUnit
...
occurrence %<>% mutate(dwc_sampleSizeUnit = recode(fuiktype
                                                   ...
                                                   ,"salamanderfuik drijvend" = "amphibian fyke floating"
...
```{r}
occurrence %<>% mutate(dwc_locality = paste(locatie,"|","number of fykes: ", no_fuiken, sep = ' '))
