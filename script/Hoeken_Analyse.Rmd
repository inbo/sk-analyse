...
|Net _niet_ verhoogd| `r nnv_metamorfen$n`  |`r nnv_metamorfen$perc`|`r nnv_metamorfen$max`|`r nnv_metamorfen$mean`|`r nnv_metamorfen$med`|
...
|Net _niet_ verhoogd| `r nnv_adulten$n`  |`r nnv_adulten$perc`|`r nnv_adulten$max`|`r nnv_adulten$mean`|`r nnv_adulten$med`|
...
if(hypo == TRUE ){
  ...
  if ( effect < 0  & effect2 > 0){
    dyn_text <- paste0("De vangstkans van ", stadia," in parallel geplaatste fuiken is hoger dan bij fuiken die in een hoek van 45° geplaatst werden (p= ", p_value, "). Maar lager dan bij fuiken die in een hoek van 90° geplaatst werden (p= ", p_value2, ").")
  }
  if ( effect > 0  & effect2 < 0){
    dyn_text <- paste0("De vangstkans van ", stadia," in parallel geplaatste fuiken is hoger dan bij fuiken die in een hoek van 90° geplaatst werden (p= ", p_value, "). Maar lager dan bij fuiken die in een hoek van 45° geplaatst werden (p= ", p_value2, ").")
  }
  if( p_value > 0.01 &   p_value2 > 0.01){
    dyn_text <- paste0(param, " heeft geen significante invloed op de vangstkans van ", stadia, " (p 45°- 00° = ",
                       p_value," & p 90°- 00° ", p_value2, ").")
  }
}
