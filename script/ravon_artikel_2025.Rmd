...
```{r}
afvangsten_per_fuik_combined <- afvangsten_per_fuik_combined %>%
  group_by(Jaar) %>%
  ...
  writexl::write_xlsx(afvangsten_per_fuik_combined, path = "./interim/RAVON_afvangsten_per_fuik_combined.")
...
writexl::write_xlsx(temp, path = "./interim/RAVON_trend_cpue_vijvers.xlsx")
