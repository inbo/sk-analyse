...
verbatimData_post_2018 <- verbatimData %>% 
  ...
  select(gbifID, lifeStage, verbatimLocality, individualCount)

lifeStages_post_2018 <- verbatimData_post_2018 %>% 
  select(gbifID, lifeStage, n = individualCount) %>% 
...
locations_missing_coords <- locations %>% 
  ...
  select(locationID, decimalLatitude.y, decimalLongitude.y)
